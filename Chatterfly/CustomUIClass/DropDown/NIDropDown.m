...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.backgroundColor = [UIColor colorWithRed:0.118f green:0.192f blue:0.216f alpha:0.8f];
    cell.textLabel.textColor = [UIColor whiteColor];
    UIView * v = [[UIView alloc] init];
//    v.backgroundColor = [UIColor colorWithRed:0.118f green:0.192f blue:0.216f alpha:0.7f];
